...
export default function Header(props) {
  return (
    <div className="main">
      ...
      {/* <section>
        <div class="product_to_deliver">
          <div class="container-lg">
            <div class="product_headng">
            ...
            <div class="container-lg">
              ...
              <div class="offer_list">
                <div class="offer_list_box">
                  ...
                  <p class="offer_details">Relish the utmost reasonable prices in the City with our effective pricing</p>
                </div>
                <div class="offer_list_box">
                  <p class="offer_icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor"
                  ...
                  <p class="offer_details">Track your belongings movement across the city with our APP</p>
                </div>
                <div class="offer_list_box">
                  <p class="offer_icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor"
                      class="bi bi-smtopwatch" viewBox="0 0 16 16">
                  ...
                  <p class="offer_details">Get it guaranteed delivered at your doorstep on the same day of your Goods</p>
                </div>
              </div>
            </div>
          </div>
